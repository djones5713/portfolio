    ...
    return (
        <div className="about-container" id="about">
            <div className="about-info">
                ...
                <a  className="about-btn" href="https://drive.google.com/file/d/1gQaVO_NZHwSdrWodc1qxLehullI7Ya0x/view?usp=sharing" target="_blank" rel="noopener noreferrer"><button>Resume</button></a>
            </div>
